                            ...
                            if (Bones[i])
                            {
                                ...
                                if (Distance <= Config.FOV) {
                                    if (Distance < GameData.AimBot.ScreenDistance) {
                                        ...
                                        GameData.AimBot.Type = EntityType::Player;
                                        Utils::Log(1, "111GameData.AimBot.ScreenDistance %f", GameData.AimBot.ScreenDistance);
                                        Utils::Log(1, "111GameData.AimBot.Target %f", GameData.AimBot.Target);
                                    }
                                }
                            }
                        }
                ...
                for (auto& Item : VehicleWheels)
                {
                    ...
                    if (Distance <= Config.WheelFOV) {
                        if (Distance < GameData.AimBot.ScreenDistance) {
                            ...
                            Utils::Log(1, "222GameData.AimBot.ScreenDistance %f", GameData.AimBot.ScreenDistance);
                            Utils::Log(1, "222GameData.AimBot.Target %f", GameData.AimBot.Target);
                        }
                    }
                }
            }
