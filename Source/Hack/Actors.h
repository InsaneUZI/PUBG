        ...
        while (true)
        {
            ...
            for (ActorEntityInfo& Entity : Entitys)
            {
                ...
                if (EntityInfo.ID == 0) {
                    ...
                    if (EntityInfo.Type == EntityType::Player || EntityInfo.Type == EntityType::AI 
                        || EntityInfo.Name.find("Zombie") != std::string::npos || EntityInfo.DisplayName.find("Zombie") != std::string::npos
                        ) {
                        Player Player;
