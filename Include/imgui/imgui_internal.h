...
//#endif
    ...
    IMGUI_API bool          MyInputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, bool show_lable = true, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
