...
namespace ImGui
{
    ...
    IMGUI_API void          EndChild(bool popstyle = true);
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags = 0, int value = 5, bool hide_lable = false);
    ...
    IMGUI_API bool          IsMouseClicked(ImGuiMouseButton button, ImGuiID owner_id, ImGuiInputFlags flags);
